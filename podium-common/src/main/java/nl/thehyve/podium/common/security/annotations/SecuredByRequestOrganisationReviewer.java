 ...
 * that is reviewer of one of the organisations to which the request is associated,
 * if the request is in a review status.
 *
...
@Documented
public @interface SecuredByRequestOrganisationReviewer {}
